...
return {
	{
		...
		config = function()
			...
			-- Apply theme colors
			vim.api.nvim_set_hl(0, "CmpNormal", { bg = theme.colors.bg })
			vim.api.nvim_set_hl(0, "CmpBorder", { fg = theme.colors.border })
			vim.api.nvim_set_hl(0, "CmpDocNormal", { bg = theme.colors.bg })
			vim.api.nvim_set_hl(0, "CmpDocBorder", { fg = theme.colors.border })
		end
	}
}
